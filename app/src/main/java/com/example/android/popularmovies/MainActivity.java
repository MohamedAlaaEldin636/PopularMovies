...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(POSTER_PATH_AND_JSON_RESPONSE_LOADER_ID, null, this);
    }
    ...
    protected void onResume() {
        ...
        if (prefPath != null){
            ...
            String mainActivityTitle = getString(R.string.unknown_movies_category_title);
            if (prefPath.equals(NetworkUtils.PATH_POPULAR))
                mainActivityTitle = getString(R.string.popular_movies_title);
            else if (prefPath.equals(NetworkUtils.PATH_TOP_RATED))
